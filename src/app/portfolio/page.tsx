...
export const metadata: Metadata = {
  title: "Portfolio",
  description:
    "Selected work and brand partnerships from Akatsuki Studio — films, campaigns, and stories across industries.",
};
  ...
  return (
    <div className="pt-28 md:pt-36">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <div className="max-w-sm md:pb-2 md:text-right">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted">
              {clientRoster.length} partners across every kind of brief.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="section-padding max-md:pt-10 pt-16 md:pt-20">
        <div className="mb-8 grid max-w-sm grid-cols-2 gap-4 border-b border-white/10 pb-6 md:mb-16 md:flex md:max-w-none md:gap-14 md:pb-8">
          <div>
