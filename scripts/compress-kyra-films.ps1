# Compress Kyra Platinum case study films for web delivery.
# Output: kebab-case .mp4 + poster .jpg in public/Kyra/
...
$folder = Join-Path $PSScriptRoot "..\public\Kyra"

$items = @(
    @{ src = "C5643.mp4"; out = "kyra-c5643.mp4" }
    @{ src = "C5678.mp4"; out = "kyra-c5678.mp4" }
    @{ src = "E63 Kyra.mp4"; out = "kyra-e63.mp4" }
    @{ src = "Kyra Insta M440i.mp4"; out = "kyra-m440i.mp4" }
    @{ src = "bENTLEY rEVIEW .mp4"; out = "kyra-bentley-review.mp4" }
    @{ src = "C2625.mp4"; out = "kyra-c2625.mp4" }
    @{ src = "Lc V8 Review.mp4"; out = "kyra-lc-v8-review.mp4" }
    @{ src = "Obsessed sti kyra.mp4"; out = "kyra-obsessed-sti.mp4" }
    @{ src = "Kyra C63s.mp4"; out = "kyra-c63s.mp4" }
    @{ src = "AKYRA SVR REEl watermark 2mp4.mp4"; out = "kyra-svr-reel.mp4" }
)
